...
export function Layout() {
  ...
  const [contextualNav, setContextualNav] =
    React.useState<ContextualNavProps | null>(null);
  ...
  const updateContextualNav = React.useCallback(
    (navProps: ContextualNavProps | null) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="text-sm text-muted-foreground">PDF Export</li>
                </ul>
              </div>
